<x-admin-layout title="Books">
    ...
    <div class="add-button-container mt-3 mb-4 w-100">
        <button class="btn btn-success w-100 d-flex justify-content-around">
                ...
                <tr>
                    ...
                    <td class="bg-white">
                        <div class="d-flex flex-column justify-content-center p-3">
                            ...
                            <button class="btn btn-info my-2" data-bs-toggle="modal" data-bs-target="#editAuthor{{ $author->id }}">
                                <span class="icon" style="color: white !important;"><i class="bi bi-pencil-square"></i></span>
                            </button>
                            ...
                            <button class="btn btn-danger my-2" data-bs-toggle="modal" data-bs-target="#deleteAuthor{{ $author->id }}">
                                <span class="icon" style="color: white !important;"><i class="bi bi-trash"></i></span>
                            </button>

                            <x-popup-delete
                                id="deleteAuthor{{ $author->id }}"
                                title="Удаление автора"
                                body="книгу {{ $author->title }}?"
                            />
