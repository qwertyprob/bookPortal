<x-admin-layout title="Books">
    ...
    <div class="add-button-container mt-3 mb-4 w-100">
        ...
        <x-popup-create id="createBookModal" :allAuthors="$allAuthors" :allGenres="$allGenres"/>
            ...
            <tr>
                ...
                <td class="bg-white">
                    <div class="d-flex flex-column justify-content-center p-3">
                        ...
                        <button class="btn btn-info my-2" data-bs-toggle="modal" data-bs-target="#editBook{{ $book->id }}">
                        ...
                        <button class="btn btn-danger my-2" data-bs-toggle="modal" data-bs-target="#deleteBook{{ $book->id }}">
